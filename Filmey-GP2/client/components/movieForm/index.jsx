  ...
  return (
    <div>
      ...
      <Container className="py-5 overflow-hidden">
        <div className="mb-3">
          <h3 className="movie-form-title neuton-normal-white-60px5">
            {movieInformation}
          </h3>
        </div>
        {/* Title */}
        ...
        {/* year */}
        <div className="my-4">
          <div className="GenreYear d-flex flex-column flex-md-row gap-1 gap-md-5">
        ...
        <div className="my-4">
          ...
          <div className="d-flex flex-column flex-md-row gap-1 gap-md-5">
            {/* Hours */}
            <div className="d-flex flex-column flex-md-row gap-1 gap-md-4">
        ...
        <div className="my-4 text-center">
          {id == 0 && (
            <button
              className="edit-movie-form-btn neuton-bold-white-30px7"
